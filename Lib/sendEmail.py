...
if __name__ == "__main__":
    sender = '403956706@qq.com'  # 用户名与发送方
    receivers = ['403956706@qq.com', 'test@wdtrgf.com.cn']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_mail = ['2557913977@qq.com']  # 抄送人

    # 口令,QQ邮箱是输入授权码，在qq邮箱设置 里用验证过的手机发送短信获得，不含空格
    mail_pass = "lyscjfovepmabibi"

    content = '''自动化测试邮件
            <h1>测试</h1>
            <h2 style="color:red">仅用于测试</h1>
            <a href="https://test-admin2.hntrgf.com.cn/logistics/goods/list">随便发的</a><br>
            <p>图片演示：</p>
